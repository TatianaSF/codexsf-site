...
- Use `Run of Show Template` to publish the agenda.
- Use `Judging Rubric` to set fair demo criteria.
- Use `Pitch Rules` to help teams prepare short demos.
- Use `Post-event Follow-up Templates` to publish a useful recap.
